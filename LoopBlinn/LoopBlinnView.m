...
- (NSArray *)triangulate {
    CTFontRef font = CTFontCreateWithName(CFSTR("American Typewriter"), 100, NULL);
    ...
    CFAttributedStringRef attributedString = CFAttributedStringCreate(kCFAllocatorDefault, CFSTR("x"), attributes);
